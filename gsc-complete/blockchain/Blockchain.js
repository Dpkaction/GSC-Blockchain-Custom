...
class GSCBlockchain {
    constructor() {
        ...
        this.isMining = false;
        this.blockTimeTarget = 120; // 2 minutes
    ...
    createGenesisBlock() {
        ...
        console.log('💰 Genesis allocation: 255 GSC only');
        ...
        console.log(`✅ GSC Genesis Block Created!`);
        console.log(`🔗 Hash: ${genesisBlock.hash}`);
        console.log(`💎 Genesis Balance: ${this.genesisReward} GSC`);
        console.log(`📊 Total Supply: ${this.currentSupply} GSC`);
        console.log(`⛏️ Remaining: ${(this.totalSupply - this.currentSupply).toLocaleString()} GSC to mine`);
    }
    ...
    minePendingTransactions(minerAddress, callback, forceMine = false) {
        if (!this.mempool.length && !forceMine) {
            console.log('⏳ Smart Mining: Waiting for transactions...');
            return null;
        }
        ...
        try {
            console.log(`🔨 Starting mining with ${this.mempool.length} transactions`);
            ...
            if (this.addBlock(newBlock)) {
                ...
                console.log(`💰 Reward: ${newBlock.reward} GSC + ${totalFees} GSC fees`);
    ...
    addBlock(newBlock) {
        ...
        if (newBlock.isValid(previousBlock)) {
            ...
            this.updateBalances();
            this.currentSupply += newBlock.reward;
            return true;
        }
    ...
    getBlockchainStats() {
        return {
            ...
            genesisBalance: this.getBalance(this.genesisAddress)
        };
    }
